...
public enum PointsOfInterest {
    ...
    BOAT("boat", "The boat's engine is leaking into the water and contaminating it", "You used the boots to get out and fix the leaking boat engine.", "Funfact:\nOne liter of oil can contaminate approx 947000 liters of water, making it undrinkable and unusable."),
    ...
    IRRIGATION("irrigation", "The irrigation system is missing a pipe and water is spilling out on the ground", "You have fixed the irrigation system, water is not getting wasted anymore.", "Funfact:\nAs soon as a pipe starts leaking, from the first drip, about one litre water per minute is lost. That is about 40,000 litres a month."),
