...
public enum PointsOfInterest {
    ...
    BOAT("boat", "You see a boat in the sea. The boats engine is leaking into the water and the water surrounding the boat is contaminated", "you used the boots to get out and fix the leaking boat engine.", "Funfact:\nOne liter of oil can contaminate ca. 947000 litters of water, making both undrinkable and unusable."),
