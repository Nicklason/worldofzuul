...
"     \\___________________________/");
        ...
        System.out.println();
        System.out.println("You are at standing on the edge og a huge water dam.");
        System.out.println("It is cold and windy.");
        System.out.println("You see a young girl next to you looking down into the water.");
        System.out.println("She looks at you and sais Hello");
        System.out.println("You should say Hello: ");
        System.out.println(">");
        System.out.println("Hello, my name is Clair, what's yours?");
        System.out.println(">");
        ...
        System.out.println("It keeps getting worse. Do you think we can do something about this?"); 
        System.out.println(">");
